...
export function validate(schema: RequestSchema) {
  return (req: Request, _res: Response, next: NextFunction): void => {
    const errors = [
      ...
      ...(schema.query ? runSchema(schema.query, (req.query as Record<string, unknown>) ?? {}) : []),
...
export const maxLength = (max: number, label = 'This field'): FieldCheck => (value) => {
  if (value === undefined) return undefined;
...
export const isNumber = (label = 'This field'): FieldCheck => (value) =>
  value !== undefined && typeof value !== 'number'
    ? `${label} must be a number`
    : undefined;

export const min = (minimum: number, label = 'This field'): FieldCheck => (value) => {
  if (value === undefined) return undefined;
...
export const max = (maximum: number, label = 'This field'): FieldCheck => (value) => {
  if (value === undefined) return undefined;
...
export const isOneOf = (allowed: string[], label = 'This field'): FieldCheck => (value) => {
  if (value === undefined) return undefined;
...
export const matches = (pattern: RegExp, label = 'This field'): FieldCheck => (value) => {
  if (value === undefined) return undefined;
